...
class SchoolPortal():
    ...
    def __init__(self,root):
        ...
        self.label1 = Label(font=('arial',15,'bold'),text='Shaheed Rajib Anmol Free Education System High School', fg='dark blue')
        ...
        Label(frame,text='Parentname:').grid(row=2,column=1,sticky=W)
        self.lastname = Entry(frame)
        self.lastname.grid(row=2, column=2)

        Label(frame,text='Sirname:').grid(row=3,column=1,sticky=W)
        self.username = Entry(frame)
        self.username.grid(row=3, column=2)

        Label(frame,text='Section:').grid(row=4,column=1,sticky=W)
        self.email = Entry(frame)
        self.email.grid(row=4, column=2)

        Label(frame,text='Class:').grid(row=5,column=1,sticky=W)
        ...
        self.tree.heading('#2',text='Parentname')
        self.tree.column('#2', width=80)
        self.tree.heading('#3',text='Sirname')
        self.tree.column('#3', width=80)
        self.tree.heading('#4',text='Section')
